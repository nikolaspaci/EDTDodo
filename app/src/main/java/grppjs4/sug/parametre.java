...
public class parametre extends Fragment {
    ...
    View.OnClickListener condition=new View.OnClickListener() {
        ...
        public void onClick(View view) {
            ...
            // set dialog message
            alertDialogBuilder
                    .setMessage("Venez me follow sur Insta : @niko_spc")
                    .setCancelable(false)
                    .setPositiveButton("Dacc",new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog,int id) {
                            Uri uri = Uri.parse("http://instagram.com/_u/niko_spc");
                            ...
                            try {
                                ...
                                startActivity(new Intent(Intent.ACTION_VIEW,
                                        Uri.parse("http://instagram.com/niko_spc")));
                            }
                            Toast.makeText(getActivity(), "Mercii ", Toast.LENGTH_SHORT).show();
